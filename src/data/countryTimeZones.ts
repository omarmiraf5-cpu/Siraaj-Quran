// Every country's IANA time zones, from the tz database's zone.tab
// (2025 release): the country is an ISO 3166 code, and its zones are listed
// in the database's own order. Country names aren't stored here — the
// browser's Intl.DisplayNames supplies them, in the reader's language.
